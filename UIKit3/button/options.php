...
$options = array(
	...
	'color'  => array(
		...
		'type'    => 'select',
		'choices' => array(
			'default'  => __( 'Default Button', 'fw' ),
			'primary' => __( 'Primary Button', 'fw' ),
			'secondary'   => __( 'Secondary Button', 'fw' ),
			'danger'   => __( 'Danger Button', 'fw' ),
			'text'   => __( 'Text Button', 'fw' ),
			'link'   => __( 'Link Button', 'fw' ),
		)
	),
);